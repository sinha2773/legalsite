...
?>
        <section class="common_banner_section">
            <div class="common_banner_images">
              <img src="images/judge-header.png">
            </div>
        </section>        
...
<b>Don’t let poor cash flow hold your business back</b><br/><br/>
<p>Trade debtors can cause significant problems in running your business.  It is important to ensure that debts are kept at a reasonable level and that no debtor be allowed to have an outstanding account for too long a period.<br/><br/> We at Southside Legal Gold Coast provide full debt recovery services.  We can assist you with:</p>
<ul>
<li>commencing Court proceedings;</li>
<li>progressing your claim;</li>
<li>securing judgement;</li>
<li>enforcing judgment;</li>
<li>bankruptcy and liquidation;</li>
</ul>
<p>At Southside Legal Gold Coast we have considerable experience in debt recovery.  We understand the practical issues involved in recovering debts and also understand that you never wish to be spending “good money” chasing “bad money”.  We aim to assist you to obtain the best possible solution.<br/><br/> Please do not hesitate to send us a free ‘no obligation’ enquiry by clicking on the ‘quick enquiry form’ that is found on the right hand side of this page.  We will get back to you quickly.</p>  
</div>  
</div>
                    </div>
                    <div class="col-md-4">
                        <div class="right_sideber">
                          <div class="right_sideber_buttons">
                            ...
                            <div class="call_center_images">
                              <img src="images/philippines-Call-Center.png">
                            </div>
                            ...
                            <div class="sidebar_overseas_title common_title_color">
                              <h3>Overseas Visitors</h3>
                            </div>
                            <div class="sidebar_oversase_images">
                              <img src="images/visitor_pic.jpg">
